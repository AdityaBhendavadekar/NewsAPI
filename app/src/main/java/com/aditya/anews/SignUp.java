...
public class SignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logInMov = findViewById(R.id.loginmov);

//        loginMov = findViewById(R.id.textView7);
        ...
        logInMov.setOnClickListener(view -> {
            finish();
        });
    }
    ...
    private void insertToDatabase() {
        ...
        editor.putString("anmobile", mobile);
        editor.putString("anpassword", confirmPass);
        editor.commit();
